...
function fFormatInput(y,m,d) {
	var td = fFormatDate(y,m,d);
	if (td=="")
		return _timeVal;
	return td+_separator_time+_timeVal;
}
...
// Other Settings
var _highlite_background="#ECFDFF";	// highlight background color
var _highlite_fontColor="#009900";	// highlight font color
