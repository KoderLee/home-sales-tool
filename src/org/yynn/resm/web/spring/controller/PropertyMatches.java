...
/**
 * Helper class for calculating bean property matches, according to. Used by BeanWrapperImpl to suggest alternatives for
...
public final class PropertyMatches {
	 ...
	 * <code>getStringDistance</code> method, which in turn uses the Levenshtein algorithm to determine the distance
	 * between two Strings.
	 * 
