 ...
 * 
 * <p>
 * Necessary as <code>Introspector.getBeanInfo()</code> in JDK 1.3 will return a new deep copy of the BeanInfo every
 * time we ask for it. We take the opportunity to cache property descriptors by method name for fast lookup.
 * Furthermore, we do our own caching of descriptors here, rather than rely on the JDK's system-wide BeanInfo cache (to
 * avoid leaks on class loader shutdown).
 * 
 * <p>
 ...
 * <code>forClass</code> method to obtain instances.
 * 
 * @author Rod Johnson
...
public final class CachedIntrospectionResults {
	...
	/**
	 * Map keyed by class containing CachedIntrospectionResults. Needs to be a WeakHashMap with WeakReferences as values
	 * to allow for proper garbage collection in case of multiple class loaders.
	 */
