...
/**
 * <p>
 * Title: TypeConverterDelegate.java
 * </p>
 * <p>
 * Description:
 * </p>
...
public class TypeConverterDelegate {
	...
	private final ModelBeanWrapperImpl propertyEditorRegistry;
	 ...
	 */
	public TypeConverterDelegate(ModelBeanWrapperImpl propertyEditorRegistry) {
	 ...
	 */
	public TypeConverterDelegate(ModelBeanWrapperImpl propertyEditorRegistry, Object targetObject) {
	...
	protected Map convertToTypedMap(Map original, String propertyName, MethodParameter methodParam) {
		...
		try {
			...
			if (logger.isDebugEnabled()) {
				logger.debug(
						"Cannot access Map of type [" + original.getClass().getName() + "] - injecting original Map as-is", ex);
			}
			return original;
		}
		boolean actuallyConverted = false;
